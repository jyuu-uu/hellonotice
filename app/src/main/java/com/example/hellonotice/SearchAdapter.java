...
public class SearchAdapter extends ArrayAdapter {
    ...
    public SearchAdapter(Context context, int resource, ArrayList<Post> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (tmp != null) {
            TextView t1 = v.findViewById(R.id.si_title);
            TextView t2 = v.findViewById(R.id.si_content);
