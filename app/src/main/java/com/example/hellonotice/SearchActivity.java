...
public class SearchActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        data.add(new Post("공지2 제목", "공지2 내용입니다. 아웃백 먹고싶다 투움바 파스타 먹고 싶다 투움바 파스타 먹고 싶다 투움바 파스타 먹고 싶다 투움바 파스타 먹고 싶다 투움바 파스타 먹고 싶다"));
        ...
        adapter = new SearchAdapter(getApplicationContext(), R.layout.search_item, data);
